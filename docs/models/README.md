...
| `实用度突破方案架构图.tldraw` | v1 | 4 大突破功能早期概念架构 | tldraw |
...
- **版本关系**：
  - v1 概念 → v2 功能实现（当前代码基线）→ v2.1 蓝图迭代（PRD §3.1/§3.2）→ v3 构思（未实现，草稿已清理）
- **配套文档**：功能需求见 `../01-product/PRD.md`，战略见 `../01-product/PRODUCT_STRATEGY.md`
