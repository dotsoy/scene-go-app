...
export interface CountrySafety {
  ...
  /** 中国驻当地使领馆领事保护电话（显示用，含国家码；特别行政区为外交部驻公署） */
  embassy: string;
  tipping: string;
  voltage: string;
  currency: string;
...
export const COUNTRY_SAFETY: CountrySafety[] = [
  ...
  },
  {
    ...
    embassy: '外交部驻港公署 +852 2106 6303',
    tipping: '多数账单已含 10% 服务费，可留零钱',
    voltage: '220V · G 型插座',
    currency: '港币 HKD',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    langCode: 'zh-MO',
    emergency: { police: '999', ambulance: '999', fire: '999' },
    embassy: '外交部驻澳公署 +853 2890 2625',
    tipping: '多数账单已含服务费，酒店行李可给零钱',
    voltage: '220V · G 型插座',
    currency: '澳门元 MOP（港元通用）',
    water: '自来水可直饮（建议瓶装）',
  ...
  },
  {
    ...
    embassy: '+855 12 901 923',
    tipping: '非强制，服务好可留零钱',
    voltage: '230V · A/C/G 型插座',
    currency: '瑞尔 KHR（美元普遍通用）',
    water: '自来水不建议直饮，买瓶装水',
  ...
  // ── 南亚/中东 ──────────────────────────────────────────────
  {
    ...
    embassy: '+91 11 2611 2345',
    tipping: '5-10%，高档餐厅 10%',
    voltage: '230V · C/D 型插座',
    currency: '印度卢比 INR',
    water: '自来水不建议直饮，买瓶装水',
  ...
  },
  {
    ...
    embassy: '+971 2 443 4276',
    tipping: '常见 10-15%，账单多已含服务费',
    voltage: '230V · G 型插座',
    currency: '迪拉姆 AED',
    water: '自来水经处理可饮（建议瓶装）',
  ...
  // ── 欧洲 ──────────────────────────────────────────────
  {
    ...
    langCode: 'en-GB',
    emergency: { police: '999', ambulance: '999', fire: '999' },
    embassy: '+44 20 7299 4049',
    tipping: '餐厅常见 10-15%，账单多含服务费',
    voltage: '230V · G 型插座',
    currency: '英镑 GBP',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    langCode: 'fr-FR',
    emergency: { police: '112', ambulance: '112', fire: '112' },
    embassy: '+33 1 4952 1950',
    tipping: '账单已含服务费，可留 5-10% 零钱',
    voltage: '230V · C/E 型插座',
    currency: '欧元 EUR',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    embassy: '+49 30 27588510',
    tipping: '非强制，餐厅常凑整或留 5-10%',
    voltage: '230V · C/F 型插座',
    currency: '欧元 EUR',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    langCode: 'it-IT',
    emergency: { police: '112', ambulance: '112', fire: '112' },
    embassy: '+39 06 96524200',
    tipping: '账单已含服务费，可留零钱',
    voltage: '230V · C/F/L 型插座',
    currency: '欧元 EUR',
    water: '自来水可直接饮用',
  ...
  // ── 北美/拉美 ──────────────────────────────────────────────
  {
    ...
    langCode: 'en-US',
    emergency: { police: '911', ambulance: '911', fire: '911' },
    embassy: '+1 202 495 2266',
    tipping: '小费文化强：餐饮 15-20%，行李 1-2 美元/件',
    voltage: '120V · A/B 型插座',
    currency: '美元 USD',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    langCode: 'en-CA',
    emergency: { police: '911', ambulance: '911', fire: '911' },
    embassy: '+1 613 789 3434',
    tipping: '餐饮 15-20%，账单多已含服务费',
    voltage: '120V · A/B 型插座',
    currency: '加元 CAD',
    water: '自来水可直接饮用',
  ...
  },
  {
    ...
    langCode: 'es-MX',
    emergency: { police: '911', ambulance: '911', fire: '911' },
    embassy: '+52 55 5616 0609',
    tipping: '餐饮 10-15%，行李 10-20 比索',
    voltage: '127V · A/B 型插座',
    currency: '墨西哥比索 MXN',
    water: '自来水不建议直饮，买瓶装水',
